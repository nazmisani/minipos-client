...
export default function ProductPage() {
  ...
  // Check if there's a "new" query parameter to trigger add modal
  useEffect(() => {
            ...
            <div className="bg-white rounded-xl p-6 w-full max-w-md">
              ...
              <div className="text-center py-8">
                ...
                <p className="text-slate-600 mb-4">
                  Product creation form will be available here
                </p>
                <div className="space-y-3">
                  <button
                    onClick={() => setShowAddModal(false)}
                    className="w-full bg-emerald-600 hover:bg-emerald-700 text-white py-2 px-4 rounded-lg"
                  >
                    Coming Soon
                  </button>
                  <button
                    onClick={() => setShowAddModal(false)}
                    className="w-full bg-slate-100 hover:bg-slate-200 text-slate-700 py-2 px-4 rounded-lg"
                  >
                    Close
                  </button>
                </div>
